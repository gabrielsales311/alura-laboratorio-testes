...
public class CandleFactoryTest {
	...
	public void negociacaoDeTresDiasDiferentesGeraTresCandlesDiferentes() {
		...
		Negociacao negociacao1 = new Negociacao(100.0, 20, hoje);
		Negociacao negociacao2 = new Negociacao(50.0, 20, hoje);
		...
		List<Negociacao> negociacoes = Arrays.asList(negociacao1,negociacao2,negociacao3,negociacao4, 
				negociacao5, negociacao6, negociacao7);
		...
		Assert.assertEquals(100.0, candlesticks.get(0).getAbertura(), 0.0000001);
